        ...
        <div className="details">
          <div className="bloc1">
            ...
            <div className="time">
                ...
                <h4><b>De 15h à 18h</b> (heure israélienne)</h4>
            </div>
            <div className="presentateur">
            <i class="fas fa-microphone"></i>
                <h4>
                  Animée par <b>Monsieur Daniel Rouach</b>, Président de la Chambre de
                  Commerce Israël-France (CCIF) et <b>Monsieur Shiran Katz</b>, Board
                  member de la CCIF).
                </h4>
            </div>
            <div className="where">
            <i class="fas fa-map-marker-alt"></i>
              <div>
                <h4><b>Chambre de Commerce Israël – France,</b></h4>
          ...
          <div className="bloc2">
                ...
                <div className="time">
                <i class="fas fa-clock"></i>
                    <h4> <b>De 18h à 19h30 </b>(heure française).</h4>
                </div>
                <div className="presentateur">
                <i class="fas fa-microphone"></i>
                    <h4>
